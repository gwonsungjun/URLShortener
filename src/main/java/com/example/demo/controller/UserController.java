...
public class UserController {
    ...
    @GetMapping("/{id}/stats")
    public ResponseEntity<Map<String, Object>> findStatisticsById(@PathVariable Long id) {
        return new ResponseEntity<>(userService.selectStatistics(id), HttpStatus.OK);
